...
metadata = {'apiLevel': '2.19',
            'protocolName': 'PS ROMP 1/2 Scale',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    pipette.transfer(G3_volume/2, well_plates_g3[G3_well], polymer_well_list[1], mix_after=(3, 200))
    ...
    protocol.delay(minutes=22)

    # Distribute G3 again
    pipette.well_bottom_clearance.dispense = 2
    pipette.well_bottom_clearance.aspirate = 0
    pipette.transfer(G3_volume, well_plates_g3[G3_well], polymer_well_list[2], mix_after=(3, 200))
    pipette.transfer(G3_volume/2, well_plates_g3[G3_well], polymer_well_list[3], mix_after=(3, 200))
