...
def run(protocol: protocol_api.ProtocolContext):
    ...
    allequotes_well_list = [well_plates['A1'], well_plates['A2'], well_plates['A3'], well_plates['A4'],
                            ...
                            well_plates['B3'], well_plates['B4'], well_plates['B5'], well_plates['B6'],
                            well_plates['C1'], well_plates['C2'], well_plates['C3'], well_plates['C4']]
    ...
    pipette.distribute([1000] * 16, beaker_100ml[THF_quench_reservoir], allequotes_well_list, disposal_volume=0)
    ...
    pipette.transfer(60, polymer_well_list[1], allequotes_well_list[3], mix_after=(2, 200))
    ...
    pipette.well_bottom_clearance.dispense = 3
    pipette.well_bottom_clearance.aspirate = 3
    pipette.transfer(60, polymer_well_list[2], allequotes_well_list[8], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[8], mix_after=(2, 200))
    pipette.transfer(60, polymer_well_list[3], allequotes_well_list[9], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[9], mix_after=(2, 200))
    ...
    pipette.well_bottom_clearance.dispense = 3
    pipette.well_bottom_clearance.aspirate = 3
    pipette.transfer(60, polymer_well_list[2], allequotes_well_list[10], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[10], mix_after=(2, 200))
    pipette.transfer(60, polymer_well_list[3], allequotes_well_list[11], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[11], mix_after=(2, 200))
    ...
    pipette.well_bottom_clearance.dispense = 3
    pipette.well_bottom_clearance.aspirate = 3
    pipette.transfer(60, polymer_well_list[0], allequotes_well_list[12], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[12], mix_after=(2, 200))
    pipette.transfer(60, polymer_well_list[1], allequotes_well_list[13], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[13], mix_after=(2, 200))
    ...
    pipette.well_bottom_clearance.dispense = 3
    pipette.well_bottom_clearance.aspirate = 3
    pipette.transfer(60, polymer_well_list[2], allequotes_well_list[14], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[14], mix_after=(2, 200))
    pipette.transfer(60, polymer_well_list[3], allequotes_well_list[15], mix_after=(2, 200))
    pipette.transfer(60, well_plates_g3[quencher], allequotes_well_list[15], mix_after=(2, 200))
